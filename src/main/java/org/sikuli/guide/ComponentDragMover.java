...
public class ComponentDragMover extends MouseAdapter{
   ...
   public ComponentDragMover(Class destinationClass, Component... components)
   ...
   public ComponentDragMover(Component destinationComponent, Component... components)
...
//      else
   ...
   DraggedMoveListener draggedMoveListener;
...
//      
//      // Need these code to position the moved component right
//      Point dragged = e.getLocationOnScreen();
//      int dragX = getDragDistance(dragged.x, pressed.x, snapSize.width);
//      int dragY = getDragDistance(dragged.y, pressed.y, snapSize.height);
//      
//      if (destination instanceof SikuliGuideComponent)
//         ((SikuliGuideComponent) destination).setActualLocation(location.x + dragX, location.y + dragY);
//      else if (destination instanceof SklComponentView)
//         ((SklComponentView) destination).setActualLocation(location.x + dragX, location.y + dragY);
//      else
//         destination.setLocation(location.x + dragX, location.y + dragY);
//      
//      destination.getLocation();
      ...
      if (draggedMoveListener != null)
         draggedMoveListener.componentMoved(source, origin, destination.getLocation());
   ...
   public void addMoveListener(DraggedMoveListener draggedMoveListener) {
      this.draggedMoveListener = draggedMoveListener;     
   }

}

interface DraggedMoveListener {  
   
   void componentMoved(Component source, Point origin, Point destination);
